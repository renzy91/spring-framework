...
final class PostProcessorRegistrationDelegate {
	...
	public static void invokeBeanFactoryPostProcessors(
		...
		if (beanFactory instanceof BeanDefinitionRegistry) {
			...
			/**
			 * 先执行自己的BeanDefinitionRegistryPostProcessor.postProcessBeanDefinitionRegistry()
			 */
			...
			/**
			 * 执行实现了PriorityOrdered接口的BeanDefinitionRegistryPostProcessor.postProcessBeanDefinitionRegistry()
			 */
			...
			/**
			 * 执行实现了Ordered接口的BeanDefinitionRegistryPostProcessor.postProcessBeanDefinitionRegistry()
			 */
			...
			/**
			 * 执行剩余的BeanDefinitionRegistryPostProcessor.postProcessBeanDefinitionRegistry()
			 */
		...
		/**
		 * 获取所有实现了BeanFactoryPostProcesso接口的类
		 * 按照优先级分类排序执行 PriorityOrdered>Ordered>其他
		 */
	...
	public static void registerBeanPostProcessors(
		...
		// 当 Spring 中高配置的后置处理器还没有注册就已经开始了 bean 的实例化过程，这个时候便会打印
		// BeanPostProcessorChecker 中的内容
		...
		for (String ppName : postProcessorNames) {
			...
			// 实例化有顺序要求的 BeanPostProcessor,并放入priorityOrderedPostProcessors中
			if (beanFactory.isTypeMatch(ppName, PriorityOrdered.class)) {
